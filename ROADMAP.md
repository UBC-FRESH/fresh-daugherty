...
| P9 E1: time-varying discount-rate shapes | [#48](https://github.com/UBC-FRESH/fresh-daugherty/issues/48) | `feature/p9-discount-shapes` | In progress — P9.1–P9.3 (#53–#55) complete, grid run + tracked; #56 (analysis) pending |
